...
pw.Widget kierowca_starajacy_sie_niepelnoletni_3_pieczatki({required MedicalJudgment judgment, required Patient patient}) {
  return pw.Column(
    children: [
        ...
        child: pw.RichText(
          text: const pw.TextSpan(
            ...
            children: [
              ...
              pw.TextSpan(
                text: ' pkt 1 / pkt 2/ pkt 3/ pkt 4/ pkt 5/',
                style: pw.TextStyle(
                  fontSize: 10,
